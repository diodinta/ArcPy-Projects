...
output_output_folder = 'C:\\1. DIODINTA\\3. Work\\11. Lain-Lain\\Long Term Flood\\Testing_Pandas\\Testing4'
...
flood_magnitude_folder = output_folder = os.path.join(output_output_folder, "2_Flood_Magnitude")
max_flood_magnitude_folder = os.path.join(output_output_folder, "3_Max_Flood_Magnitude")
...
def extract_alert_area(crop_folder, threshold_folder, threshold_file, extract_folder):
    ...
    print("processing flood Magnitude are done")
    print(".......")
    print(".......")
    print(".......")
    print(".......")
...
def final_csv_magnitude_rainfallrate(output_folder):
    ...
    print("start adding colomn date and threshold into csv file......")
    print("creating folder to store csv version 2.....")
...
print("Start processing flood magnitude")
print("........")
...
print("Start processing maximum flood magnitude")
print("........")
print("creating folder to save flood magnitude ")
gdb_max_flood_magnitude_folder = "Max_Flood_Magnitude"
gdb_max_flood_magnitude_folder_gdb = "Max_Flood_Magnitude.gdb"
os.mkdir(max_flood_magnitude_folder)
max_flood_magnitude_folder_raster = os.path.join(max_flood_magnitude_folder, "1_Raster_Max_FM")
...
print("create folder to stored shapefile...")
max_FM_shapefile_folder = os.path.join(max_flood_magnitude_folder,'2_shapefile_Max_FM')
...
final_input_name = 'max_floodmagnitude_{0}.csv'.format(year)
csv_sorted = csv_to_sort.reindex_axis(sorted(csv_to_sort.columns), axis=1)
